...
* Intuitive **Java Swing** GUI for interaction and navigation
* Local data persistence using **SQLite**
* Designed to support shelter workflow and data management
* Lightweight and easy to extend for future development

## Technologies Used

* **Java** – Main programming language
* **Java Swing** – UI design and frontend
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/Kourosh-Delavar/animal-shelter-system-prototype
   ```
2. Open the project in your favorite Java IDE (e.g., IntelliJ IDEA, Eclipse).
3. Build and run the main application class to launch the prototype.
